  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      <header className="border-b w-full">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6 mx-auto w-full max-w-7xl">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    SehatNama stores and manages patient information, medical
                    history, prescriptions, and lab reports in a secure digital
                    environment.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  SehatNama provides a comprehensive solution for healthcare
                  data management
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Maintain detailed patient profiles and treatment history in one secure location",
                  icon: <CheckCircle className="h-10 w-10 text-teal-600" />,
                },
                {
                  title: "Prescription Management",
                  description:
                    "Store and track prescriptions with automatic warnings for risky medicine combinations",
                  icon: <FileText className="h-10 w-10 text-teal-600" />,
                },
                {
                  title: "Lab Reports",
                  description:
                    "Store and access lab reports digitally, including scanned documents",
                ...
                },
                {
                  ...
                  description:
                    "Different access levels for doctors, admins, and patients",
                  icon: <Shield className="h-10 w-10 text-teal-600" />,
                },
                {
                  title: "Fast Searches",
                  description:
                    "Quick access to patient records using advanced indexing techniques",
                  icon: <Database className="h-10 w-10 text-teal-600" />,
                },
              ].map((feature, index) => (
                <div
      ...
      <footer className="border-t bg-gray-50 w-full">
        <div className="container flex flex-col gap-4 py-10 md:flex-row md:gap-8 md:py-12 px-4 md:px-6 mx-auto w-full max-w-7xl">
          <div className="flex flex-col gap-2 md:gap-4 md:flex-1">
            ...
            <p className="text-sm text-gray-500">
              A digital healthcare database system for Pakistan and beyond.
            </p>
          </div>
